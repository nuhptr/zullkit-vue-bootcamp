  ...
  >
    ...
    >
      ...
      <div class="md:order-2">
        ...
        <a
          href="register.html"
          class="px-8 py-3 text-base font-medium text-white bg-[#160442] border border-transparent rounded-full bg-navy hover:bg-navy md:py-2 md:text-sm md:px-8 hover:shadow"
        >
          Sign Up
        </a>
      </div>
